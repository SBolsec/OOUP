...
int main()
{
    ...
    const char *maxchar = mymax(&arr_char[0], &arr_char[sizeof(arr_char) / sizeof(*arr_char)], gt_int);
    std::vector<std::string>::iterator it1 = mymax(strings.begin(), strings.end(), gt_str);
